      ...
      <div className="rounded-2xl border bg-white shadow-sm p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Fastest response • Mon–Sat</p>
            <p className="text-lg font-medium text-gray-900 mt-2">Chat with us directly</p>
          </div>
        </div>
        <div className="mt-4">
      ...
      <div className="rounded-2xl border bg-white shadow-sm p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-0.5">Talk to an instructor • 9am–6pm</p>
            <p className="text-xl font-bold text-gray-900 mt-2">{DISPLAY_PHONE}</p>
          </div>
        </div>
        <div className="mt-4">
          <SecondaryButton href={TEL_HREF}>Call us now</SecondaryButton>
        </div>
      </div>
      ...
      <div className="rounded-2xl border bg-white shadow-sm p-6">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-gray-500 mt-0.5">We reply the same day</p>
            <p className="text-base font-medium text-gray-900 mt-2 break-all">{EMAIL}</p>
          </div>
        </div>
        <div className="mt-4">
          <PrimaryButton href={MAILTO}>Send an email</PrimaryButton>
        </div>
      </div>
    </div>
  );
